/* Fanta Live 3.1.4 — fix definitivo stabilità touch + coerenza filtri */
(function(){
  'use strict';
  ...
  */
  ...
  function bind(){
    ...
    const v=document.querySelector('.aboutTitle span');if(v)v.textContent='Versione pubblica 3.1.4 · Liquid Glass';
